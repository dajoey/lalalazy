...
public unsafe class OverrideMovement : IDisposable {
    ...
    public OverrideMovement() {
        ...
        Svc.Log.Debug($"RMIWalk address: 0x{_rmiWalkHook.Address:X}");
        Svc.Log.Debug($"RMIFly address: 0x{_rmiFlyHook.Address:X}");
        ...
        Svc.Log.Debug($"RMIWalkIsInputEnabled1 address: 0x{rmiWalkIsInputEnabled1Addr:X}");
        Svc.Log.Debug($"RMIWalkIsInputEnabled2 address: 0x{rmiWalkIsInputEnabled2Addr:X}");
