...
public static class Communicator
{
  ...
  public static void PrintSweepDone(int listed, int failures, int vendored = 0, int heldBack = 0, int vendorFailures = 0, int pulled = 0, int unconfirmed = 0, int routed = 0)
  {
    ...
    Svc.Chat.Print(Prefix + FormatDoneLine(listed, failures, vendored, heldBack, vendorFailures, pulled, unconfirmed, routed));
  }
  ...
  /// </summary>
  public static string FormatDoneLine(int listed, int failures, int vendored, int heldBack, int vendorFailures, int pulled = 0, int unconfirmed = 0, int routed = 0)
    => AutoMarket.DoneLine.Format(listed, failures, vendored, heldBack, vendorFailures, pulled, unconfirmed, routed: routed);
