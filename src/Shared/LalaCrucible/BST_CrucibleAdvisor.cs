...
///     board's rank sync). PURE shared SOURCE (src/Shared/LalaCrucible): GluttonyCombo's horn warning reads
///     <see cref="Pick"/>; LazyCrucible's familiar selection ranks with <see cref="PickSlots"/> /
///     <see cref="PickSlotsCoverage"/> and shows the advisor panel. Compiled into both harnesses too.
/// </summary>
