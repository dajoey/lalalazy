...
//Svc.GameGui.HoveredActionChanged += OnHoveredActionChanged; // API changed
...
//Svc.GameGui.HoveredActionChanged -= OnHoveredActionChanged;
	...
	{
		// HoveredAction.ActionID/ActionKind removed in Dalamud API 15
		// Functionality disabled until API migration
		currentContextAction = null;
	}
